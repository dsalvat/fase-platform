...
export function AIProposalsDialog({ month }: AIProposalsDialogProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Propuestas de Big Rocks con IA
          </DialogTitle>
          <DialogDescription>
            La IA genera propuestas basadas en tu historial. Selecciona las que quieras crear como borrador.
          </DialogDescription>
        </DialogHeader>
        ...
        {!loading && proposals.length > 0 && (
          <DialogFooter className="flex-row gap-2 sm:justify-between">
            <p className="text-xs text-muted-foreground self-center">
              {selected.size} de {proposals.length} seleccionados
            </p>
              ...
              >
                {creating ? (
                  ...
                  <>
                    ...
                    Crear {selected.size} borrador{selected.size !== 1 ? "es" : ""}
                  </>
                )}
              </Button>
            </div>
