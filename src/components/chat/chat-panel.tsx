  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="w-full sm:max-w-md p-0 flex flex-col [&>button:last-child]:hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full p-6 text-center text-muted-foreground">
              <MessageCircle className="w-12 h-12 mb-4 text-muted-foreground/50" />
        ...
        {/* Error message */}
        {error && (
          <div className="px-4 py-2 bg-red-50 dark:bg-red-950/50 text-red-600 dark:text-red-400 text-sm">
        ...
        {/* No credits warning */}
        {noCredits && !error && (
          <div className="px-4 py-2 bg-yellow-50 dark:bg-yellow-950/50 text-yellow-700 dark:text-yellow-400 text-sm">
            {t.noCredits}
          </div>
        )}
